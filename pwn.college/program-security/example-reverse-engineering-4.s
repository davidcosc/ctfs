...
open:
    ...
    129d:	48 89 7d f8          	mov    QWORD PTR [rbp-0x8],rdi vm buf addr
    12a1:	48 89 75 f0          	mov    QWORD PTR [rbp-0x10],rsi vm buf addr+register a value
    ...
    12ae:	48 8b 45 f0          	mov    rax,QWORD PTR [rbp-0x10] vm buf addr+register a value
    12b2:	89 d6                	mov    esi,edx register b value as flags
    12b4:	48 89 c7             	mov    rdi,rax vm buf addr+register a value as file name addr
...
read_input:
    ...
    12cf:	48 89 7d f8          	mov    QWORD PTR [rbp-0x8],rdi vm buf addr
    12d3:	89 75 f4             	mov    DWORD PTR [rbp-0xc],esi register a value
    12d6:	48 89 55 e8          	mov    QWORD PTR [rbp-0x18],rdx vm buf addr+register b value
    ...
    12e2:	48 8b 4d e8          	mov    rcx,QWORD PTR [rbp-0x18] vm buf addr+register b value
    12e6:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc] register a value
    12e9:	48 89 ce             	mov    rsi,rcx vm buf addr+register b value as inbuf
...
read_register:
    ...
    13a7:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    13ba:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    13cd:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    13e0:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    13f3:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
...
write_register:
    ...
    1450:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    1469:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    147f:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    1495:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    14ab:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    14c1:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] vm buf addr
    ...
    14d1:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8] unknown: vm buf addr
    14d5:	48 8d 35 2c 1b 00 00 	lea    rsi,[rip+0x1b2c] unknown register str addr
    14dc:	48 89 c7             	mov    rdi,rax vm buf addr
...
write_memory:
    ...
    152d:	88 0c 02             	mov    BYTE PTR [rdx+rax*1],cl to vm buf addr+register 1 value
    1530:	90                   	nop
    1531:	5d                   	pop    rbp
    1532:	c3                   	ret
...
interpret_add:
    ...
    1589:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18] vm buf addr
    158d:	89 d6                	mov    esi,edx register num 1
    158f:	48 89 c7             	mov    rdi,rax vm buf addr
    ...
    159d:	48 8b 45 e8          	mov    rax,QWORD PTR [rbp-0x18] vm buf addr
...
interpret_stmt:
    ...
    16d9:	e8 29 fe ff ff       	call   1507 <sleep@plt+0x397> write memory vm buf addr+register 1 value = register 2 value
    16de:	90                   	nop
...
interpret_input:
    ...
    18a2:	48 89 7d d8          	mov    QWORD PTR [rbp-0x28],rdi vm buf addr
    ...
    18bd:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    ...
    18d9:	48 8b 75 d8          	mov    rsi,QWORD PTR [rbp-0x28] vm buf addr
    18dd:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    18e1:	0f b6 80 00 01 00 00 	movzx  eax,BYTE PTR [rax+0x100] ragister a value
    18e8:	0f b6 c0             	movzx  eax,al register a value
    18eb:	48 01 c6             	add    rsi,rax vm buf addr+register a value
    18ee:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    18f2:	48 89 c7             	mov    rdi,rax vm buf addr
    ...
    1901:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    1905:	89 ce                	mov    esi,ecx register num
    1907:	48 89 c7             	mov    rdi,rax vm buf addr
    ...
    191e:	48 8b 55 d8          	mov    rdx,QWORD PTR [rbp-0x28] vm buf addr
    1922:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    1926:	0f b6 80 01 01 00 00 	movzx  eax,BYTE PTR [rax+0x101] register b value
    192d:	0f b6 c0             	movzx  eax,al register b value
    1930:	48 01 d0             	add    rax,rdx vm buf addr+register b value
    1933:	48 89 45 f0          	mov    QWORD PTR [rbp-0x10],rax vm buf addr+register b value
    1937:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    ...
    1951:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    ...
    196d:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    1971:	0f b6 80 00 01 00 00 	movzx  eax,BYTE PTR [rax+0x100] register a value
    1978:	0f b6 f0             	movzx  esi,al register a value
    197b:	48 8b 55 f0          	mov    rdx,QWORD PTR [rbp-0x10] vm buf addr+register b value
    197f:	48 8b 45 d8          	mov    rax,QWORD PTR [rbp-0x28] vm buf addr
    1983:	48 89 c7             	mov    rdi,rax vm buf addr
    ...
    1998:	48 89 c7             	mov    rdi,rax vm buf addr
...
execute_program:
    ...
    1da2:	48 89 c7             	mov    rdi,rax vm buf addr
    1da5:	e8 be f7 ff ff       	call   1568 <sleep@plt+0x3f8> interpret add b = b+c = 0x7a
    1daa:	48 8b 85 58 ff ff ff 	mov    rax,QWORD PTR [rbp-0xa8] vm buf addr
    1db1:	48 8d 48 52          	lea    rcx,[rax+0x52] # vm buf addr+input addr offset
    1db5:	48 8b 85 58 ff ff ff 	mov    rax,QWORD PTR [rbp-0xa8] vm buf addr
    1dbc:	48 83 c0 72          	add    rax,0x72 vm buf addr+expected value addr offset
...
main:
    ...
    1f37:	48 8d 95 f0 fe ff ff 	lea    rdx,[rbp-0x110] vm buf addr
    1f3e:	b8 00 00 00 00       	mov    eax,0x0 value
    1f43:	b9 20 00 00 00       	mov    ecx,0x20 number qwords to set
    1f48:	48 89 d7             	mov    rdi,rdx vm buf addr
    ...
    1f64:	48 8d 85 f0 fe ff ff 	lea    rax,[rbp-0x110] vm buf addr
    1f6b:	48 89 c7             	mov    rdi,rax vm buf addr
